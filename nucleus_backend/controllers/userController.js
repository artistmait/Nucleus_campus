...
const signupUser = async (req, res) => {
    try{
        ...
        const exists = await pool.query("SELECT * FROM users WHERE moodle_id = $1", [moodle_id]);
        // console.log(exists)
        ...
        const now = new Date();
        const newUser = await pool.query("INSERT INTO users (moodle_id,password,role_id,department_id,created_at) VALUES ($1,$2,$3,$4,$5) RETURNING * ",[moodle_id, hashedPassword ,role_id,department_id,now] );
